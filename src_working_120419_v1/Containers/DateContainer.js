...
class DateContainer extends React.Component {
  ...
  searchAvailability() {
    ...
    console.log("JSON.stringify(this.props.roomsList.RoomData) : ", this.props.roomsList);
    filterData = [
      ...filterData,
  ...
  handleSearch() {
    ...
    // this.props.dispatch(getRoomService());
    // this.props.dispatch(getRoomService().then(
    //   response => {
    ...
    if (this.state.checkInDateFlag && this.state.checkOutDateFlag) {
      if (this.state.checkOutDateValue > this.state.checkInDateValue) {
        ...
        setTimeout(()=>console.log("Delay After service roomData : ", this.props.roomsList),25000);
        this.searchAvailability();
        // setTimeout(() => this.searchAvailability(), 25000);
        //   //Set the dates
        this.props.dispatch(
          selectedDate(
  ...
  componentDidMount() {
    ...
    // setTimeout(() => this.props.dispatch(getRoomService()), 25000);
